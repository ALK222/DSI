...
\begin{itemize}
    ...
    \item \textit{La competencia total a la aplicación está formada principalmente por kayak, Omio, eDreams, Momondo y SkyScanner.}
    \item \textit{La competencia parcial a la aplicación está formada por Booking e Iberia.}
