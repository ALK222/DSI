...
El reparto de ventanas para la realización del prototipo ha sido el siguiente:
\begin{itemize}
    \item Daniel ha realizado la ventana de \textit{Inicio de sesión}.
    \item Javier ha hecho la página de \textit{Registro} y la de \textit{Modificar perfil}.
    \item Laura ha realizado la página de \textit{Inicio}.
    \item Leire ha realizado tanto la página de \textit{Pago} como la de \textit{Perfil}.
    \item Rodrigo ha realizado la página de \textit{Soporte}.
    \item María ha hecho la página \textit{Modificar reserva}.
    \item Alejandro ha hecho la página \textit{Datos adicionales}.
    \item Carlos y Pablo han hecho juntos las ventanas de \textit{Preguntas frecuentes} y \textit{Comparador}.
    \item Guillermo ha realizado las ventanas de \textit{Mis reservas} y \textit{Consultar reserva}.
    \item Sergio se ha dedicado al volcado de la información de las distintas ventanas a la memoria.
\end{itemize}
