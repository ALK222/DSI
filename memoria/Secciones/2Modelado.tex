...
\begin{table}[h]
    ...
    \begin{tabular}{|p{0.33\linewidth}|p{0.33\linewidth}|p{0.33\linewidth}|}
        \hline
        \textbf{Viajante que usa comparadores de viajes (Marta González Torres)} & \textbf{Viajante que no usa comparadores de viajes (Juan Martínez Torres)} & \textbf{Viajante con discapacidad} \\ \hline
        \begin{itemize}
            \item Edad: 18-25
...
\begin{minipage}{0.4\textwidth}
    ...
    Edad: \colorbox{yellow!20}{23 años} \\
    Sexo: Mujer \\
...
Marta no puede salir de su casa sin los auriculares. Para ella la música es una gran parte de su vida, y todas las mañanas, en la parada del bus, \colorbox{yellow!20}{se prepara un playlist personalizada en Spotify} para el itinerario hasta la Universidad. \colorbox{yellow!20}{Vive en Fuenlabrada}, por lo que tiene una ruta de una hora hasta que llega a Madrid, \colorbox{yellow!20}{donde va a clase en la UCM}. A Marta sobre todo le gusta la música italiana, ya que en el 2020 se fue de Erasmus a Turin y se enamoró tanto de su cultura como de su música. Su cantante favorita es Francesca Michielin, así que cuando hace gira intenta ir a algún concierto suyo en una \colorbox{yellow!20}{ciudad italiana en la que no haya estado}.
Se da la casualidad de que a su hermano Julián también le gusta mucho Francesca, así que en varias ocasiones \colorbox{yellow!20}{han ido ellos de viaje junto a sus padres} Carlos y Elena, los cuáles se van a cenar juntos mientras sus hijos están en el concierto. \colorbox{yellow!20}{Esto no lo hacen muy a menudo} debido a que solo van cuando hay un concierto en alguna ciudad que les resulte interesante a toda la familia. Normalmente se encarga ella de hacer la reserva tanto de los vuelos, \colorbox{yellow!20}{para lo que usa SkyScanner, como del alojamiento, utilizando AirBnB en este caso}. \\

Con respecto al tema universitario, a Marta se le está haciendo cuesta arriba. Se metió inicialmente en telecomunicaciones porque \colorbox{yellow!20}{se le daban bien las matemáticas y la tecnología}, pero la carrera no fue lo esperado. A pesar de las dificultades, la carrera le gusta y querría terminarla, ya que este será en principio su último año. Pero estos problemas la agobian bastante, y para distraerse le gusta mucho \colorbox{yellow!20}{ir a festivales de música por España}. Suele ir todos los años al festival Starlite, pues Pablo, el novio de su hermano y con el que mantiene muy buena relación, es de Marbella, y se puede quedar algunos días en la playa aprovechando el viaje. Pero a pesar de que no tiene que pagar gastos de alojamiento, el evento musical es bastante caro (ya que va varios días), por lo que \colorbox{yellow!20}{intenta ahorrar lo máximo posible en el viaje}. Para eso usa comparadores de viaje como Omio.

\subsection{Juan Martínez Díaz}

\begin{minipage}{0.4\textwidth}
    \textbf{Información general} \\

    Edad: \colorbox{yellow!20}{24 años} \\
    Sexo: Hombre \\
    Estudios: Derecho \\
...
\hfill
\begin{minipage}{0.4\textwidth}
    \includegraphics[width=0.5\textwidth]{Imagenes/Personas/Juan.jpg} % Reemplaza "imagen.jpg" con el nombre de tu archivo de imagen y su ubicación
\end{minipage}

\textbf{Background personal} \\

Juan es una persona muy extrovertida y activa, siempre buscando nuevos retos y experiencias. Es por eso por lo que a su temprana edad \colorbox{yellow!20}{ha conseguido un puesto de relevancia en un importante bufete de abogados} y ha conseguido independizarse de sus padres en \colorbox{yellow!20}{un pequeño piso cerca de Moncloa}. \\

Aunque estudió derecho en la Universidad Complutense de Madrid \colorbox{yellow!20}{empezó un curso de programación en Java} ya que le parecía muy interesante aprender y en sus ratos libres realiza pequeños programas que luego prueba y enseña a sus amigos. \\

El bufete en el que trabaja tiene diferentes sedes alrededor del mundo y \colorbox{yellow!20}{de vez en cuando le mandan a comprobar que el trabajo se está realizando correctamente} en cada una, estos viajes les resultan muy cómodos ya que tiene un equipo de personas que le organizan la estancia. \colorbox{yellow!20}{Además de estos viajes, Juan se va de vacaciones cada año fuera de España y cada dos fuera de Europa, le gusta invitar a sus amigos o familia en alguno de los viajes}. \\

Juan conoció a su pareja en el gimnasio de su barrio hace 4 años y desde que están juntos les resulta muy complicado verse entre semana debido a los horarios de ambos. Al año de noviazgo decidieron que para pasar tiempo juntos harían \colorbox{yellow!20}{una escapada cada dos semanas} usando páginas de viajes aleatorios o directamente decirle al hermano de María (su novia) que trabaja en una agencia de viajes, que les organice el viaje.
