...
\begin{itemize}
    ...
    Pestañas para seleccionar el medio de transporte.
    En las opciones si destaca por algo (más rápida, más barata..).
    Encima de la lista de opciones, en botones, los tres métodos de de ordenación más utilizados y todos los filtros disponibles
