...
\begin{itemize}
    ...
    \item\textbf{Cancelar viaje:} \\ Pablo y Javi optan por la misma opción descrita en la “Pantalla de reservas” pero tambíen en la propia página de cancelar viajes.
\end{itemize}
