...
\begin{itemize}
    \item Crear el cuestionario y dividirlo en secciones.
    \item Distribuir el cuestionario por distintos medios para alcanzar una gran cantidad de usuarios.
    \item Analizar los datos y sacar conclusiones.
\end{itemize}
